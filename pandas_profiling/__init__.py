...
from pandas_profiling.features import important_features
...
class ProfileReport(object):
    ...
    def __init__(self, df, target, **kwargs):
        """Constructor see class documentation
        """
        sample = kwargs.get('sample', df.head())
        
        # Manmohan added below line for important features
        imp_features =important_features(df,target)
        ...
        self.html = to_html(sample, imp_features, description_set)
